...
<html lang="es">
  <head>
    ...
    <meta name="author" content="Seba Dorado">
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        ...
        <form class="login-form" id="formLogin" name="formLogin" action="">
          <h3 class="login-head text-primary"><i class="fa fa-md fa-fw fa-user"></i>Iniciar Session</h3>
          ...
          <div id="alertLogin" class="text-center">
            <div class="form-group btn-container">
              <button type="submit" class="btn btn-primary btn-block"><i class="fas fa-sign-in-alt mr-2"></i>Iniciar Session</button>
            </div>
          </div>
        </form>

        <form id="formResetPass" name="formResetPass" class="forget-form" action="">
          <h3 class="login-head text-primary"><i class="fa fa-sm fa-fw fa-lock"></i>Recuperar Contraseña</h3>
