    ...
    <div class="col-md-3">
      <div class="tile p-0">
        <ul class="nav flex-column nav-tabs user-tabs">
          ...
          <!-- SECCION PAGOS <li class="nav-item"><a class="nav-link" href="#datos" data-toggle="tab">Pagos</a></li>-->
        </ul>
      </div>
    </div>
    <div class="col-md-9">
      <div class="tab-content">
        <div class="tab-pane active" id="user-timeline">
          <div class="timeline-post">
            <div class="post-media">
              <div class="content">
                <h5 class="text-danger p-2 mr-2">DATOS PERSONALES <button class="btn btn-sm btn-info ml-2" type="button" onclick="openModalPerfil();"><i class="fas fa-pencil-alt" aria-hidden="true"></i></button></h5>
              </div>
            </div>
        ...
        <!--SI QUEREMOS AGREGAR OTRA SECCION-->
