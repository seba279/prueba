...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-07-2021 a las 01:45:58
...
CREATE TABLE `categorias` (
  `idcategorias` bigint(20) NOT NULL,
...
--
ALTER TABLE `categorias`
  MODIFY `idcategorias` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `producto`
  ADD CONSTRAINT `producto_ibfk_1` FOREIGN KEY (`categoriaid`) REFERENCES `categorias` (`idcategorias`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
